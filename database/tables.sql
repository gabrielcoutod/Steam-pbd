...
CREATE TABLE Categorizacao (
    ...
    FOREIGN KEY (fk_Categoria_id) REFERENCES Categoria (id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE Classificacao (
    ...
    FOREIGN KEY (fk_Genero_id) REFERENCES Genero (id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (fk_App_id) REFERENCES App (id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE Desenvolvedora (
    ...
    FOREIGN KEY (fk_Empresa_id) REFERENCES Empresa (id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (fk_App_id) REFERENCES App (id) ON UPDATE CASCADE ON DELETE CASCADE
);
